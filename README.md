...
[Zheng Gao](https://zaczgao.github.io)<sup>1,*</sup>, [Debin Meng](https://scholar.google.com/citations?user=8Wc3A1IAAAAJ&hl=en)<sup>1</sup>, [Yunqi Miao](https://yoqim.github.io)<sup>2</sup>, [Zhensong Zhang](https://zhangzhensong.github.io)<sup>2</sup>, [Songcen Xu]()<sup>2</sup>, [Ioannis Patras](https://sites.google.com/view/ioannispatras/home)<sup>1</sup>, [Jifei Song](https://scholar.google.com/citations?user=9a1PjCIAAAAJ&hl=en)<sup>2</sup>

<sup>1</sup>Queen Mary University of London, <sup>2</sup>Huawei London Research Center

<sup>*</sup>Tech Lead & Corresponding Author

[![arXiv](https://img.shields.io/badge/arXiv-FRAM---red)](https://arxiv.org/abs/)

---


## Updates
- **[2026/02/18]** **FRAM** [CVPR'26] code is released.
...
**FRAM** is a diffusion-based facial makeup transfer model with regional controllability. It can perform global makeup transfer and region-specific makeup transfer.
...
<p align="center">
  <img src="assets/makeup-overview.png" alt="FRAM Architecture" width="100%">
</p>
...
To synthesize the makeup style images (for fine-tuning CLIP) and before-and-after makeup pairs (for training diffusion), run:
```bash
...
python -u ./utils/create_makeup_pair.py \
  ...
  --out_dir=${OUT_DIR} \
  --name=makeup_pair_ffhq_${EDIT_MODEL} \
...
### Fine-tuning CLIP (Stage 1)

```bash
bash ./scripts/run_style_clip.sh
```

### Fine-tuning diffusion (Stage 2)
...
The weights are available at [Hugging Face]()
