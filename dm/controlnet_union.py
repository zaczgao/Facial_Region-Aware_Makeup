...
from diffusers.models.embeddings import TextImageTimeEmbedding, TextTimeEmbedding, TimestepEmbedding, Timesteps
...
class ControlNetUnionModel(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    def __init__(
        ...
        self.controlnet_cond_embedding = nn.ModuleList([ControlNetConditioningEmbedding(
    ...
    def forward(
        ...
        emb = emb + control_emb if control_emb is not None else emb
        ...
        for idx, (cond, control_idx, scale) in enumerate(zip(controlnet_cond, control_type_idx, conditioning_scale)):
            condition = self.controlnet_cond_embedding[idx](cond)
