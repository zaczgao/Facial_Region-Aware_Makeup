...
if __name__ == '__main__':
    ...
    control = ControlLoRAModel.from_unet(unet)
    ...
    unet_params = {pn: p for pn, p in unet.named_parameters() if p.requires_grad}
    control_params = {pn: p for pn, p in control.named_parameters() if p.requires_grad}
    print(list(control_params.keys()))